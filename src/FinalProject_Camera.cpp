...
int main(int argc, const char *argv[])
{
    ...
    results << "Detector, Descriptor, Image id, No matched keypoints in ROI, TTC lidar, TTC camera\n"; 
        ...
        for (auto des=listDescriptors.begin(); des!=listDescriptors.end(); des++)
        {
            ...
            for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
            {
                ...
                if (dataBuffer.size() > 1) // wait until at least two images have been processed
                {
                    ...
                    // printing bbBestMatches  
                    /*
                    cout << "\nThe map bbBestMatches is : \n"; 
                ...
                results << detectorType << "," << descriptorType << "," << imgIndex << "," 
                    << noMatchesInROI << "," << ttcLidar << "," << ttcCamera <<"\n";
